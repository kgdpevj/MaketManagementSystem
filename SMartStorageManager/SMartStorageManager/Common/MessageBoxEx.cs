...
namespace SMartStorageManager.Common
{
    ...
    public static class MessageBoxEx
    {
        ...
        public static DialogResult Show(string message, string caption, string attachMessage, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
        {
            ...
            { throw new InvalidEnumArgumentException(InvalidDfButtonExString); }
        ...
        private class MessageForm:Form
        {
            ...
            private class MessageViewer:Control
            {
                ...
                public override Size GetPreferredSize(Size proposedSize)
                {
                    ...
                    if(wellSize.Height > proposedSize.Height)
                    { wellSize.Height = proposedSize.Height; }
...
SUVORK5CYII=";
                ...
                public bool Checked
                {
                    ...
                    set
                    {
                        if(isChecked == value || !isToggleMode)
                        { return; }
                ...
                protected override void OnHandleCreated(EventArgs e)
                {
                    ...
                    { btnStruct.fsStyle = 0x2; }//BTNS_CHECK。作为切换按钮时
                    ...
                    {
                        if(btnStructStart != IntPtr.Zero)
                        { Marshal.FreeHGlobal(btnStructStart); }
                    }
                }
